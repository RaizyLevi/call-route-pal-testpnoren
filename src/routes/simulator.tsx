...
const MOCK_RESPONSES = [
  "id_list_message=t-כדי להגיע ליעד, גשו לתחנת הרכבת סבידור מרכז וקחו את קו 450 לכיוון תל אביב. זמן הנסיעה המשוער הוא 45 דקות. נסיעה טובה!",
  "id_list_message=t-למעבר המהיר ביותר, גשו לתחנת האוטובוסים המרכזית וקחו את קו 402. משך הנסיעה כ-32 דקות. שימו לב לעדכוני תנועה בדרך. נסיעה בטוחה!",
  "id_list_message=t-המסלול המומלץ: צאו מתחנת רכבת ההגנה וקחו את קו 319 לכיוון ירושלים. זמן הגעה משוער — שעה ועשר דקות. תיהנו מהנסיעה!",
  "id_list_message=t-כדי להגיע במהירות, גשו לרחוב אלנבי וקחו את קו 5 לכיוון התחנה המרכזית. משך הנסיעה המשוער הוא 18 דקות. נסיעה נעימה!",
  "id_list_message=t-המסלול היעיל ביותר: גשו לתחנת רכבת תל אביב-השלום וקחו את הרכבת לכיוון חיפה. זמן הנסיעה המשוער הוא שעה וחצי. נסיעה מהנה!",
  "id_list_message=t-לדרך הקצרה ביותר, גשו לתחנת האוטובוסים ברחוב יפו וקחו את קו 480 לכיוון אשדוד. זמן הגעה משוער — 50 דקות. נסיעה טובה!",
];
